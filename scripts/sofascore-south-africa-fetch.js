/**
 * Sofascore fetch logic — run inside browser context.
 * South Africa team id: 4736
 */
export async function fetchSouthAfricaFromSofascore(opts = {}) {
  const TEAM_ID = 4736;
  const TEAM_NAME = 'South Africa';
  const SOFASCORE_NAMES = ['South Africa'];
